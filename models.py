...
class NearEarthObject:
    ...
    def __init__(self, designation, name, diameter, hazardous, **info):
        ...
        if designation == "":
            raise ValueError("Null designation not accepted")
        ...
        #             self.diameter = float(diameter) if diameter != '' else float('nan')
            ...
            print(f"Invalid value for diameter '{diameter}'")
            raise e
    ...
    def __str__(self):
        ...
        return (
            f"A NearEarthObject(designation={self.designation}, name={self.name}, "
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        return (
            f"A CloseApproach(time={self.time_str}, distance={self.distance:.2f}, "
